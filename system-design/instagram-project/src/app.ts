...
import { startFeedRefreshWorker, stopFeedRefreshWorker } from './workers/feedRefreshWorker';
...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerSpec, {
  ...
  customSiteTitle: 'Instagram API Documentation',
}));
